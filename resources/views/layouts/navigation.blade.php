    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.menus')" :active="request()->routeIs('admin.menus')">
                    {{ __('Kelola Menu') }}
                </x-responsive-nav-link>
            @else
                ...
                <x-responsive-nav-link :href="url('/menu')" :active="request()->is('menu')">
                    {{ __('Menu Katering') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('cart')" :active="request()->routeIs('cart')">
                    {{ __('Keranjang') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('arsip.index')" :active="request()->routeIs('arsip.index')">
                    {{ __('Riwayat Pesanan') }}
                </x-responsive-nav-link>
            @endif
